...
namespace MvcViaturas.Controllers
{
    public class ViaturasController : Controller
    {
        ...
        public ViaturasController(MvcViaturasContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Viatura != null ? 
                          ...
                          Problem("Entity set 'MvcViaturasContext.Viatura'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MvcViaturasContext.Viatura'  is null.");
            }
            var viatura = await _context.Viatura.FindAsync(id);
            if (viatura != null)
            {
